...
<head>
    ...
    <title>Vibe Bricklaying Ltd.</title>
    <style>
        body {
            font-family: Arial, sans-serif;
            margin: 0;
            padding: 0;
            background-image: url('https://via.placeholder.com/1920x1080?text=Construction+Background');
        ...
        header {
            background-color: rgba(44, 62, 80, 0.9); /* Slightly transparent for readability */
            color: white;
            text-align: center;
            padding: 2rem;
        }
